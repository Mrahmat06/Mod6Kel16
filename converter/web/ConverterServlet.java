        ...
        try {
            ...
            if ((degree != null) && (degree.length() > 0)) {
                ...
                if (request.getParameter("C TO K") != null) {
                    ...
                    out.println("<p>" + degree + " Kelvin are " + centigrade + " Celcius.</p>");
                }
                if (request.getParameter("K TO C") != null) {
                    String fahrenheit = cb.ftoc(d);
                    out.println("<p>" + degree + " Celcius are " + fahrenheit + " Kelvin.</p>");
                }
            } else {
                ...
                out.println("<br/>");
                out.println("<input type=\"submit\" name=\"K TO C\" value=\"C TO K\">"
                        + "<input type=\"submit\" name=\"C TO K\" value=\"K TO C\">");
                out.println("</form>");
            }
        } finally {
            out.println("</body>");
